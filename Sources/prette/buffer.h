...
class Buffer {
 ...
 public:
  ...
  static inline auto CopyFrom(const uint8_t* data, const uint64_t length) -> BufferPtr {
    return CopyFrom(data, length, length);
  }

  static inline auto CopyFrom(const std::string& data) -> BufferPtr {
    return CopyFrom((const uint8_t*)data.data(),
