...
class WorldInitializer {
 ...
 public:
  static void Append(WorldInitializer** list, WorldInitializer* value);
  static void Remove(WorldInitializer** list, WorldInitializer* value);
};
...
class WorldGenerator {
 ...
 protected:
  ...
  void AddInitializer(WorldInitializer* rhs) {
    ASSERT(rhs);
    WorldInitializer::Append(&initializers_, rhs);
  }

  void RemoveInitializer(WorldInitializer* rhs) {
    ASSERT(rhs);
    WorldInitializer::Remove(&initializers_, rhs);
  }
