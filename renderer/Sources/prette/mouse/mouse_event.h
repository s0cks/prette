...
class MouseSettingsChangedEvent : public MouseEventBase {
 public:
  MouseSettingsChangedEvent(const Mouse* mouse) :
    MouseEventBase(mouse) {}
  ~MouseSettingsChangedEvent() override = default;
  DECLARE_EVENT_TYPE(MouseEvent, MouseSettingsChanged);
};
...
class DragFinishedEvent : public DragEvent {
 ...
 public:
  ...
  auto IsDragDown() const -> bool;
  auto IsDragUp() const -> bool;
